...
public class ClockDisplay
{
    ...
    //The constructor should set hours as a NumberDisplay object with hour as the limit
    //The constructor should set minutes as a NumberDisplay object with minute as the limit
